 ...
 if (this.cart.length > 0){
    for (let i = 0; i < this.foods.length; i++) { 
      for (let j = 0; j < this.cart.length; j++) { 
        if (this.foods[i].id == this.cart[j].id){  
            ...
            if (this.cart[j].selectedItem.length > 0){
              ...
              this.foods[i].quantiy =+ this.cart[j].selectedItem[x].total 
              }
            }else{
              this.foods[i].quantiy = this.cart[j].quantiy
            }
        } 
      }
    }
 ...
 if (this.cart.length > 0){
    for (let i = 0; i < this.foods.length; i++) { 
      for (let j = 0; j < this.cart.length; j++) { 
        ...
        //  this.foods[i].quantiy = 0 
console.log(this.foods[i],'zeroed')
        }
      }
    }
    } 
